        ...
        <b-card class="mt-2 mb-2 rounded-lg">
          <h2>
            ...
            <vue-custom-tooltip
              position="is-bottom"
              :multiline="true"
              label="These members are looking for someone like you based on what you told us about yourself in your profile. If you don't agree, you can update your profile."
            >
              <svg
                version="1.1"
                id="Capa_1"
                ...
                style="enable-background: new 0 0 29.536 29.536"
                xml:space="preserve"
                height="20"
                class="info-icon"
              >
...
import types from "@/components/theyareyourtype.vue";
import searchComponent from "@/components/Seeking/reversedSeeking.vue";
export default {
  name: "search",
  components: {
    types,
