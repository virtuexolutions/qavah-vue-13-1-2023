              ...
              >
                ...
                <div class="info">
                  ...
                  <div class="right-bubbles">
                    ...
                    <!-- Reversed -->
                    <!-- <span class="custom-filter-reversed">Reversed</span> -->
                  </div>
                </div>
              </div>
  ...
  data() {
    return {
      ...
      iBelieveIAMOptions: [
        ...
        {
          text: "I am a gentile grafted into the israelite covenant (grafted in)",
          value:
            "I am a gentile grafted into the israelite covenant (grafted in)",
        },
        {
          text: "I believe i am of the 12 tribes (12 tribes chart)",
          value: "I believe i am of the 12 tribes (12 tribes chart)",
        },
      ],
  ...
  methods: {
    ...
    submit() {
      ...
      setTimeout(() => {
        ...
        axios
          .post(`${apiUrl}/seeking/reversed-seeking`, data, { headers })
          .then((res) => {
            console.log("res -> ", res);
            const data = res.data;
            if (res.status === 200) {
