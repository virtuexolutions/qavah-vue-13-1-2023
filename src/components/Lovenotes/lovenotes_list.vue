<template>
  <div class="mt-2">
    ...
    <h2 class="mt-2 section-heading">Who Send you a Lovenotes</h2>
                ...
                <div class="info">
                  <router-link :to="'/dashboard/profile/' + person.id">
                    ...
                    <p class="status p-0 m-0">
                      {{ person.user_lovenote.love_notes }}
                    </p>
                  </router-link>
                  <p class="status p-0 m-0">
                    <time-ago
                      long
                      :datetime="person.user_lovenote.created_at"
                    ></time-ago>
                  </p>
                </div>
              </div>
    ...
    getViewedData() {
      ...
      setTimeout(() => {
        if (this.currentUser.id) {
          ...
          axios
            .post(`${apiUrl}/favoured/get_lovenotes`, data, {
              headers,
            })
            .then((response) => {
